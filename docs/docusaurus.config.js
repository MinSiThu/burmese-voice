...
const config = {
  ...
  url: 'https://burmese-voice.vercel.app/',
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/MinSiThu/burmese-voice/tree/main/docs/docs',
        },
        blog: {
          ...
          // Remove this to remove the "edit this page" links.
          editUrl:
            'https://github.com/MinSiThu/burmese-voice/tree/main/docs/blog',
        },
        theme: {
